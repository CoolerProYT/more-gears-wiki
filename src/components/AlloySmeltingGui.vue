                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <div class="grid grid-cols-2">
                            <LoopItemSlot :item="slot_1" />
                            <LoopItemSlot :item="slot_2" />
                        </div>
                        <div class="w-full flex justify-center py-2">
                            <img :src="furnaceFire" class="size-8 md:size-10" alt="Furnace Fire">
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="col-span-2 flex justify-center">
                                <ItemSlot :item="'minecraft:coal'" />
                            </div>
                        </div>
                    </div>
...
<script setup>
import furnaceFire from "@/assets/img/furnace_fire.png";
import LoopItemSlot from "@/components/LoopItemSlot.vue";
