<template>
    <div class="minecraft-gui bg-[#c6c6c6] border-4 border-[#373737] border-t-[#FFFFFF] border-l-[#FFFFFF] p-2 max-w-md my-3 h-fit">
...
export default {
    ...
    props: ['slot_1', 'slot_2', 'slot_3', 'output', 'output_count'],
}
</script>
