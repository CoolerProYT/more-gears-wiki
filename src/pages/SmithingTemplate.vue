        ...
        <div class="md:w-9/12 px-3">
            ...
            <div class="w-full border-b py-5 scroll-mt-18" id="titaniumUpgrade">
                ...
                <div class="mt-4 scroll-mt-18" id="obtainingTitanium">
                    ...
                    <div>
                        <CraftingGui
                            slot_1="minecraft:netherite_ingot"
                            slot_2="mod:netherite_upgrade_smithing_template"
                            slot_3="minecraft:netherite_ingot"
                            slot_4="minecraft:netherite_ingot"
                            slot_5="mod:titanium_ingot"
                            slot_6="minecraft:netherite_ingot"
                            slot_7="minecraft:netherite_ingot"
                            slot_8="minecraft:netherite_ingot"
                            slot_9="minecraft:netherite_ingot"
            ...
            <div class="w-full py-5 scroll-mt-18" id="enderiteUpgrade">
                ...
                <div class="mt-4 scroll-mt-18" id="obtainingEnderite">
                    ...
                    <div>
                        <CraftingGui
                            slot_1="mod:titanium_ingot"
                            slot_2="mod:titanium_upgrade_smithing_template"
                            slot_3="mod:titanium_ingot"
                            slot_4="mod:titanium_ingot"
                            slot_5="mod:enderite_ingot"
                            slot_6="mod:titanium_ingot"
                            slot_7="mod:titanium_ingot"
                            slot_8="mod:titanium_ingot"
                            slot_9="mod:titanium_ingot"
